...
/*   Updated: 2024/02/27 15:42:54 by fkoolhov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	iter(int_array, 5, print_template<int>);
	std::cout << std::endl;

	std::cout << YELLOW BOLD "\nTesting with char array:\n" OFF;
	char char_array[] = {'a', 'b', 'c', 'd', 'e'};
	iter(char_array, 5, print_template<char>);
	std::cout << std::endl;
	
	std::cout << YELLOW BOLD "\nTesting with string array:\n" OFF;
	std::string string_array[] = {"Wow", "it's", "a", "string", "array!"};
	iter(string_array, 5, print_template<std::string>);
	std::cout << std::endl;
	...
	iter(family, 2, print_template<t_test_struct>);
